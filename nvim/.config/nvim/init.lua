...
-- Structured in sections: FOUNDATION → PLUGINS → UI → SEARCH → LSP → FORMAT → AUTOCOMPLETE → TREESITTER
...
do
  ...
  vim.keymap.set('n', '<leader>sb', current_buffer_fuzzy_find, { desc = '[S]earch [B]uffer' })
...
-- ============================================================
-- SECTION 9: USER PLUGINS
-- ============================================================

-- Load user plugins from lua/custom/plugins/*.lua
